                                ...
                                <div class="col-lg-12">
                                    <form class="" role="form" method="post" data-target='form' action="processor.php">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="checkbox">
                                                <?php
                                                $catalogs = unserialize($data['catalog']);
                                                foreach ($cats as $ck => $c)
                                                {
                                                    ?>
                                                    <label> <input name="catalog[]" type="checkbox" value="<?= $ck; ?>" <?= in_array($ck, $catalogs) ? 'checked="checked"' : ''; ?>> <?= $c; ?></label>
                                                    <?php
                                                }
                                                ?>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            {
                                                ?>
                                                <div><a href="<?= UPLOAD_Image . $data['img']; ?>" target="_blank"><img class="img-thumbnail" src="<?= $obj->get_pre_img($data['img']); ?>"/></a><br/><br/></div>
                                            <?php }
                                            ?>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-lg-2">
                                                <label>結束時間</label>
                                                <input name="edates"  value="<?= $data['sdates']; ?>" readonlytype="text" class="form-control" required/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label>文字敘述</label>
                                        ...
                                        <a href="projects.php" class="btn btn-default"><span class="glyphicon glyphicon-log-out"></span> 取消</a>
