                ...
                <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                <a class="active" href="static_contact.php"><i class="fa fa-bar-chart-o fa-fw"></i> Contact</a>
                            </li>
                        </ul>
                    </div>
                    <!-- /.sidebar-collapse -->
                                    ...
                                    <div class="col-lg-12">
                                        <form role="form" method="post" action="processor.php">
                                            <div class="form-group">
                                                <textarea name="contact" class="form-control" rows="10"><?= stripslashes($content['contact']); ?></textarea>
                                            </div>
